...
class acf_field_year extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->defaults = array(
			//'font_size'	=> 14,			// add default here to merge into your field. 
			'year_range' => 20,
		);
		...
		*  var message = acf._e('year', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-year'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-year', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-year');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-year', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-year');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-year'),
		}
